...
type BookClient interface {
	// Sends a greeting
	GetBooks(ctx context.Context, in *GetBooksRequest, opts ...grpc.CallOption) (*GetBooksReply, error)
}
...
func (c *bookClient) GetBooks(ctx context.Context, in *GetBooksRequest, opts ...grpc.CallOption) (*GetBooksReply, error) {
	out := new(GetBooksReply)
	err := c.cc.Invoke(ctx, "/service.Book/GetBooks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BookServer interface {
	// Sends a greeting
	GetBooks(context.Context, *GetBooksRequest) (*GetBooksReply, error)
...
func (UnimplementedBookServer) GetBooks(context.Context, *GetBooksRequest) (*GetBooksReply, error) {
...
func _Book_GetBooks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/service.Book/GetBooks",
	}
